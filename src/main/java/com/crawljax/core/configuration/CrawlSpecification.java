 ...
 * @version $Id: CrawlSpecification.java 489 2011-06-10 21:13:09Z amesbah $
 */
public class CrawlSpecification {
	...
	public void clickDefaultElements() {
         ...
         * more pages in the taget. However, it slow down a bit the process.
         * TODO: make this dynamically for each page according to its links.
         */ 
